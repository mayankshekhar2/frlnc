...
module.exports = {
    ...
    'Validate that Related Posts Section is present on post page' : function (browser) {
        postPage.validateRelatedPostsPresent(browser);
    },

    before : function () {
    	log.logInfo('Start of Related Posts on Post Page Test');
        return this;
    },
    ...
    after : function (browser) {
        try {
            ...
            browser.end();
            log.logInfo('End of Related Posts on Post Page Test');
        }
    }
};