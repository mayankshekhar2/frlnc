...
module.exports = {
    ...
    'Validate that comments section is present for post' : function (browser) {
        postPage.validateCommentSectionPresent(browser);
    },

    before : function () {
    	log.logInfo('Start of Comments Section on Post Page Test');
        return this;
    },
    ...
    after : function (browser) {
        try {
            ...
            browser.end();
            log.logInfo('End of Comments Section on Post Page Test');
        }
    }
};