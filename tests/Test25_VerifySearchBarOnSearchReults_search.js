...
module.exports = {
    ...
    'Verify Search Bar is visible on the page.' : function (browser) {
        searchPage.validatesearchBoxVisible(browser);
    },

    before : function () {
    	log.logInfo('Start of Test to Validate that search box is visible on search results page.');
        return this;
    },
    ...
    after : function (browser) {
        try {
            ...
            browser.end();
            log.logInfo('End of Test to Validate that search box is visible on search results page.');
        }
    }
};